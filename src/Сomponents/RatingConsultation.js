...
export default function RatingConsultation(props) {
    ...
    if (consultationRating === 0) alert('Оцените качество консультации');
      ...
      fetch(`https://api.telegram.org/bot1752464306:AAFS4oQfbgTApz1yjHiwBp7BfoK4KUaNVOM/sendMessage?chat_id=-1001286130652&parse_mode=html&text=${message}`, {
        ...
        if (!response.ok) {
          ...
          document.getElementById('modal__thanks').style.display = 'flex';
          document.getElementById('modal__thanks').style.opacity = '1';
        } else {
  ...
  return (
    <>
      ...
      <div id="modal__thanks" className="modal__ modal-style">
        <div className="modal-style-wr">
          <div className="modal-style-cnt">
            ...
            <div className="modal-content f-c-c-s">
              ...
              <div className="modal_header w-100 f-r-c-s">
                ...
                <h4>Дякую за звернення</h4>
              </div>

              <div className="sbmt w-100 sbmt_recall" onClick={() => { window.location.href = "/"; }}>
                <label className="f-r-c-c">
                  <p>Продовжити</p>
                </label>
              </div>
                ...
                <div className="rating_f">
                  <span className="star-cb-group w-100">
                    <input type="radio"
                      ...
                      name="rating"
                      value="4"
                      checked={consultationRating === 5}
                      onChange={(e) => { return e.target.checked ? setConsultationRating(+e.target.value + 1) : null; }} />
                ...
                <div className="rating_f">
                  <span className="star-cb-group w-100">
                    <input
                      ...
                      name="rating_video"
                      value="4"
                      checked={videoRating === 5}
                      onChange={(e) => { return e.target.checked ? setVideoRating(+e.target.value + 1) : null; }} />
                    ...
                    <input
                      ...
                      name="rating_video"
                      value="3"
                      checked={videoRating === 4}
                      onChange={(e) => { return e.target.checked ? setVideoRating(+e.target.value + 1) : null; }} /><label
